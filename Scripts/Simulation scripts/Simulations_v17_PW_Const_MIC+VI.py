...
#drugs
k = [5,1.75,4,2] # hill parameters for each hypothetical drug
G_min = [-3/60, -0.0654, None, None] # for bactericidal antibiotics only
killtype = ['C','C','S','S'] # static 'S' or for cidal 'C'
drugtype=['add','add','add','add'] # add for additive drug effect and prop for proportional
...
y_range = [-0.9999, 3.5] # range for MIC changes
...
folder_name="Simulations_v17_PW_Const_MIC+VI"
...
#%%
data_interval = 30 # in mins, interval for which data processing is performed
